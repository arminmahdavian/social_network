...
class Profile(models.Model):
    ...
    country = models.ForeignKey(to=Country, on_delete=models.CASCADE, related_name='countries')
...
class Device(models.Model):
    ...
    device_os = models.CharField('device os', max_length=20, blank=True, null=True)
    device_model = models.CharField('device model', max_length=50, blank=True, null=True)
    app_version = models.CharField('app version', max_length=20, blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
